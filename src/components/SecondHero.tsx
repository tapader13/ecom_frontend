...
const SecondHero = () => {
  return (
    <div className='mt-10 '>
      <div className='cont grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-2 gap-7 grid-rows-3'>
        <div className='sm:row-span-2 relative h-[250px] sm:h-[100vh] overflow-hidden '>
          <Image
            src={'/asset 53.jpeg'}
            fill
            alt='sec-1'
